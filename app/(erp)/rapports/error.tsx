...
export default function RapportsError({
  error,
  reset,
}: {
    ...
    >
      <div className="rounded-2xl border border-gray-100 bg-white p-10 max-w-lg w-full text-center shadow-sm">
        ...
        <h1 className="text-xl font-bold text-gray-800 mb-2">
          Erreur du module Rapports
        </h1>
        <p className="text-gray-500 text-sm mb-6 leading-relaxed">
          Une erreur est survenue lors de la génération ou du chargement des rapports.
          Réessayez ou retournez au tableau de bord.
        </p>
