...
const parcelles = [
  ...
  { id: "PAR-A3", nom: "Bloc A - Zone Nord 3", surface: 4.8, culture: "Cacao AA", stade: "Production", cert: "RA", derniereOp: "Taille 10/07", prochainActe: "Ã‰pandage K 20/07", score: 88, alerte: true },
...
export default function CulturesPage() {
  ...
  const load = () => { dbGet<Record<string, unknown>>("cultures").then(setRows); };
  ...
  return (
    ...
    <div>
      ...
      <ModalRecolte
        ...
        onSubmit={async ({ parcelle: nom, qualite: variete, quantite, operateur, notes }) => {

          await dbPost("cultures", {
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  {(rows.length > 0
                    ...
                    ? rows.map((r) => ({
                        ...
                        culture: String(r.variete ?? ""),

                        stade: String(r.stade ?? ""),

                        cert: String(r.statut ?? ""),

                        derniereOp: "-",

                        prochainActe: "-",

                        score: Number(r.progress ?? 75),
            ...
            {activeTab === "cacao" && (
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl p-5" style={{ backgroundColor: "#F8FBF8" }}>
                  ...
                  <p className="text-xs text-gray-500">6 parcelles Â· Total : 23,6 ha Â· Variété : Forastero hybride (F1, F3)</p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
                    ...
                    {[
                      ...
                      { periode: "Déc-Jan", label: "Post-récolte Â· Taille", done: false, current: false },
                    ...
                    <table className="w-full text-sm">
                      ...
                      <thead>
                        ...
                        <tr style={{ backgroundColor: "#F8FBF8" }}>
                          ...
                          {["Parcelle", "Surface", "Variété", "Ã‚ge plant.", "Cabosses/arbre", "Poids moy.", "Rendement prévu", "Alertes"].map((h) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    {[
                      ...
                      { dot: "#F9A825", text: "Ã‰pandage KCl 4 t - PAR-A3 - Prévu 20/07/2025 (si livraison SCPA reçue)" },
            ...
            {activeTab === "anacarde" && (
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl p-5" style={{ backgroundColor: "#F8FBF8" }}>
                  ...
                  <p className="text-xs text-gray-500">4 parcelles anacarde Â· Total : 21,2 ha Â· Période récolte : Mars-Mai (TERMINÃ‰E 2025)</p>
            ...
            {activeTab === "vivrieres" && (
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl p-5" style={{ backgroundColor: "#F8FBF8" }}>
                  ...
                  <p className="text-xs text-gray-500">PAR-D1 (5,6 ha) : Maïs cycle 2 en préparation + Riz (semis Avr'récolte Aoû en cours) Â· PAR-E2 (5,8 ha) : Maïs cycle 1 en récolte</p>
