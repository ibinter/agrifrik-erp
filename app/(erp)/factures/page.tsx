      ...
      <main className="flex-1 p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Facturation clients et suivi des paiements â€” SYSCOHADA</p>
          </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 px-5 py-4 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2 border border-gray-200 rounded-lg px-3 py-1.5 bg-gray-50 sm:ml-auto w-full sm:w-48">
              ...
              <input
                type="text"
                placeholder="Rechercher clientâ€¦"
                value={search}
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-gray-500 whitespace-nowrap">
                        {f.paiement ?? <span className="text-blue-600 font-medium">â€”</span>}
                      </td>
