...
export const MOBILE_MONEY_OPERATORS: MobileMoneyConfig[] = [
  {
    ...
    nom: "Orange Money",
    actif: true,
    numeroReception: process.env.ORANGE_MONEY_NUMBER ?? "+225 07 78 88 25 92",
    titulaire: "IBIG SARL",
    pays: ["CI", "SN", "ML", "BF", "CM"],
  ...
  },
  {
    ...
    actif: true,
    numeroReception: process.env.MTN_MOMO_NUMBER ?? "+225 05 55 05 99 01",
    titulaire: "IBIG SARL",
    pays: ["CI", "GH", "CM", "BJ"],
  ...
  },
  {
    ...
    nom: "Wave",
    actif: true,
    numeroReception: process.env.WAVE_NUMBER ?? "+225 07 78 88 25 92",
    titulaire: "IBIG SARL",
    pays: ["CI", "SN"],
  ...
  },
  {
    ...
    nom: "Moov Money",
    actif: true,
    numeroReception: process.env.MOOV_MONEY_NUMBER ?? "+225 01 53 59 55 44",
    titulaire: "IBIG SARL",
    pays: ["CI", "BJ", "BF"],
